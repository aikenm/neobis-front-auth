    ...
    return (
        <div className='modal-overlay'>
            <div className='modal-email-content'>
                <h3 className='modal-email-title'>Мы выслали еще одно письмо<br /> на указанную вами почту <br /><span className='user-email'>{userEmail}</span></h3>
                <h4 className='modal-email-subtitle'>Не забудьте проверить <br />ящик "Спам"</h4>
